...
| WS-5 | UI | Lead session | `ws/5a-ui-spine` | **5a done** (budget, library, refresh, plan wiring, capture copy). **5b outstanding:** constraints screen, in-store substitution, favorites/comparison | WS-1 ✓ WS-3 ✓ WS-4 ✓ |
