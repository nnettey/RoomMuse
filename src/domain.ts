...
export function createProject(style:Style,images:Project["sourceImages"],legacy?:LegacyConcept):Project{
  ...
  return{projectId:"project-"+Date.now(),sourceImages:images,selectedStyle:style,concepts:cs,selectedConceptId:cs[0]!.id,comparisonPosition:50,priorityFilter:"All",sortPreference:"recommended",createdAt:now,updatedAt:now};
}
